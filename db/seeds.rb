...
Video.create([
  { title: 'Bugs Bunny, A Cartoon Revue',
    ...
    poster_small_url: '/poster_small/bugs-bunny-a-cartoon-revue-1953.jpg',
    poster_large_url: '' },
  { title: 'Casablanca',
    ...
    poster_small_url: '/poster_small/casablanca.jpg',
    poster_large_url: '' },
  { title: 'Gone with the Wind',
    ...
    poster_small_url: '/poster_small/gone-with-the-wind.jpg',
    poster_large_url: '' },
  { title: 'It Happened At the World\'s Fair',
    ...
    poster_small_url: '/poster_small/it-happened-at-the-world-s-fair-1963.jpg',
    poster_large_url: '' },
  { title: 'King Kong',
    ...
    poster_small_url: '/poster_small/king-kong.jpg',
    poster_large_url: '' },
  { title: 'Metropolis',
    ...
    poster_small_url: '/poster_small/metropolis.jpg',
    poster_large_url: '' },
  { title: 'Shall We Dance',
    ...
    poster_small_url: '/poster_small/shall-we-dance.jpg',
    poster_large_url: '' },
  { title: 'Steamboat Willie',
    ...
    poster_small_url: '/poster_small/steamboat-willie.jpg',
    poster_large_url: '' },
  { title: 'The Wizard of Oz',
    ...
    poster_small_url: '/poster_small/the-wizard-of-oz-1939.jpg',
    poster_large_url: '' }
])
