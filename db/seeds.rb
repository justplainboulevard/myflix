...
Video.create!([
  { title: 'Bugs Bunny, A Cartoon Revue',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/bugs-bunny-a-cartoon-revue-1953.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'Casablanca',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/casablanca-1942.jpg')),
    category_ids: [4, 8],
  ...
  { title: 'Gone with the Wind',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/gone-with-the-wind-1939.jpg')),
    category_ids: [4, 8],
    created_at: 72.years.ago },
  { title: 'It Happened At the World\'s Fair',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/it-happened-at-the-world-s-fair-1963.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'King Kong',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/king-kong-1933.jpg')),
    category_ids: [4, 8],
  ...
  { title: 'Metropolis',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/metropolis-1927.jpg')),
    category_ids: [4, 8],
  ...
  { title: 'Shall We Dance',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/shall-we-dance-1937.jpg')),
    category_ids: [4, 15],
  ...
  { title: 'Steamboat Willie',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/steamboat-willie-1928.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'The Wizard of Oz',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/the-wizard-of-oz-1939.jpg')),
    category_ids: [4, 8],
  ...
  { title: 'Brave',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/brave-2012.jpg')),
    category_ids: [3, 4],
  ...
  { title: 'Bullitt',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/bullitt-1968.jpg')),
    category_ids: [1, 4, 19],
  ...
  { title: 'Caddyshack',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/caddyshack-1980.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'Captain America: The First Avenger',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/captain-america-2011.jpg')),
    category_ids: [1],
  ...
  { title: 'Captain America: The Winter Soldier',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/captain-america-2-2014.jpg')),
    category_ids: [1],
  ...
  { title: 'Casino Royale',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/casino-royale-2006.jpg')),
    category_ids: [1, 19],
  ...
  { title: 'Despicable Me 2',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/despicable-me-2-2013.jpg')),
    category_ids: [3, 5],
    created_at: 1.year.ago },
  { title: 'Ferris Bueller\'s Day Off',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/ferris-bueller-s-day-off-1986.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'Kill Bill Volume 1',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/kill-bill-vol-1-2003.jpg')),
    category_ids: [1],
  ...
  { title: 'Monty Python and the Holy Grail',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/monty-python-and-the-holy-grail-1975.jpg')),
    category_ids: [4, 5],
  ...
  { title: 'Peter Pan',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/peter-pan-1953.jpg')),
    category_ids: [3, 4],
    created_at: 61.years.ago },
  { title: 'Pinocchio',
    description: 'A living puppet, with the help of a cricket as his conscience, must prove himself worthy to become a real boy.',
    small_cover: File.open(File.join(Rails.root, 'public/images/pinocchio-1940.jpg')),
    category_ids: [3, 4],
  ...
  { title: 'Sabrina',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/sabrina-1954.jpg')),
    category_ids: [4, 8],
  ...
  { title: 'Skyfall',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/skyfall-2012.jpg')),
    category_ids: [1, 19],
    created_at: 2.years.ago },
  { title: 'The Goonies',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/the-goonies-1985.jpg')),
    category_ids: [3, 4],
    created_at: 29.years.ago },
  { title: 'The Hangover',
    description: 'Three buddies wake up from a bachelor party in Las Vegas, with no memory of the previous night and the bachelor missing. They make their way around the city in order to find their friend before his wedding.',
    small_cover: File.open(File.join(Rails.root, 'public/images/the-hangover-2009.jpg')),
    category_ids: [5],
  ...
  { title: 'The Lego Movie',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/the-lego-movie-2014.jpg')),
    category_ids: [3, 5],
    created_at: 1.year.ago },
  { title: 'The Pink Panther',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/the-pink-panther-1963.jpg')),
    category_ids: [4, 5],
    created_at: 51.years.ago },
  { title: 'Thunderball',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/thunderball-1965.jpg')),
    category_ids: [1, 4, 19],
  ...
  { title: 'Toy Story 3',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/toy-story-3-2010.jpg')),
    category_ids: [3],
  ...
  { title: 'You Only Live Twice',
    ...
    small_cover: File.open(File.join(Rails.root, 'public/images/you-only-live-twice-1967.jpg')),
    category_ids: [1, 4, 19],
